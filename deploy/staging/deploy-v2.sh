...
#
#   bash deploy/staging/deploy-v2.sh            # deploy to medx-member-portal-v2.netlify.app
...
SRC="${ROOT}/user-portal/frontend-v2"
SITE_ID="${SITE_ID:-e95abaec-b28f-4f9f-be30-042a6025e854}"          # medx-member-portal-v2
