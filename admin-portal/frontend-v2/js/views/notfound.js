...
<div data-screen-label="404" style="min-height:100vh;background:#f6f2ea;color:#201b16;font-family:Inter,sans-serif">
  <div class="mx-gutter" style="max-width:1180px;margin:0 auto;padding:54px 28px 60px;text-align:center">
    ...
    <div style="font-size:13px;color:#6d6459;line-height:1.6;max-width:420px;margin:12px auto 0">The address <span style="font:600 12px Inter,sans-serif;font-variant-numeric:tabular-nums;color:#201b16">${ctx.path}</span> matches no admin destination — the search field finds every screen and person.</div>
