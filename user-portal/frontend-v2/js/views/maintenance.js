...
import { enterSystem } from './notfound.js';   // the System Pages entrance (copy rises, photo settles)
...
<div data-screen-label="System Pages" style="font-family:Inter,sans-serif;color:#191512;min-height:100vh">
  ...
  <div style="min-height:100vh;position:relative;overflow:hidden;display:flex;flex-direction:column">
    <img src="/assets/photo-ballroom.jpg" alt="" data-enter="settle" style="position:absolute;inset:0;width:100%;height:100%;object-fit:cover">
    <div style="position:absolute;inset:0;background:linear-gradient(180deg,rgba(25,21,18,.78) 0%,rgba(25,21,18,.9) 100%)"></div>
    <div data-enter="rise" style="position:relative;flex:1;display:flex;flex-direction:column;align-items:center;justify-content:center;text-align:center;padding:30px;color:#f7f1e6">
