...
const FAQ_ENTRIES = [
    ...
    { id: 'P3', section: 'payment', esc: 'team',
        ...
        a: { en: 'All Med&X event tickets are non-refundable. Once a place is purchased we are unable to refund it if you cancel or do not attend, because we commit those funds to venue, catering, and program costs in advance. If Med&X cancels or postpones an event, our Refund policy explains your options. If your situation is exceptional, I can pass it to the team to review case by case, though a refund is not guaranteed. Would you like me to do that?',
             hr: 'Sve ulaznice za Med&X događanja nepovratne su. Nakon kupnje mjesta ne možemo izvršiti povrat ako otkažete ili ne dođete, jer ta sredstva unaprijed obvezujemo za prostor, ugostiteljstvo i program. Ako Med&X otkaže ili odgodi događanje, Vaše mogućnosti opisane su u našim Pravilima povrata. Ako je Vaša situacija iznimna, mogu je proslijediti timu na pojedinačnu procjenu, no povrat nije zajamčen. Želite li da to učinim?' } },
