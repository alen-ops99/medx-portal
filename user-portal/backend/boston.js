...
// Master Plexus sheet mirror REMOVED (Alen 2026-09-02): Boston rows belong only to the
    ...
    function reminderEmailHtml(reg, opts) {
        ...
        const asks = [];
        asks.push(line(1, `<b>Tell us your dietary preference and any food allergies</b>${tag('optional')}<br><span style="color:${soft};font-size:13px;">Dinner is served during the evening.</span>`));
      ...
      <table role="presentation" width="100%" cellpadding="0" cellspacing="0"><tr><td style="padding-top:16px;">${emailTemplates.btn('Open my personal page', me, 'solid', 'padding:15px 28px;font-size:12px;')}</td></tr></table>
      <div style="font-family:${T.sans};font-size:12.5px;line-height:1.6;color:${soft};margin-top:8px;">This is your personal link.</div>
      <div style="font-family:${T.sans};font-size:14.5px;line-height:1.7;color:${ink};margin-top:18px;">See you soon!</div>
      ${ticketLight}
